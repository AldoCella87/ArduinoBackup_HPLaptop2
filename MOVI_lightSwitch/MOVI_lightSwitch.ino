...
void setup()  
{
  ...
  recognizer.callSign("Sori"); // Train callsign Arduino (may take 20 seconds)
  recognizer.addSentence("What is the password"); // Add sentence 1
...
void loop() // run over and over
{
  ...
  if (res==1) {                     // Sentence 1.
    ...
    recognizer.say("here you go!"); // Speak a sentence
  } 
  if (res==2) {                    // Sentence 2 
