...
// Default SSID name
const char* SSID_NAME = "TheLakeCottage";

// Default main strings
#define SUBTITLE "Welcome Message"
#define TITLE ""
#define BODY "Message 1."
#define POST_TITLE "Updating..."
#define POST_BODY "Message body....</br>Thank you."
#define PASS_TITLE "Message 2"
#define CLEAR_TITLE "Message 3"
...
String sMessage =   "Hello Friends.  Welcome to the Lake Cottage.  Here is some information to help make your stay more enjoyable "
                    "  Use this code at Jeffs place: AQKK WRCZBK 5MGA3  "  
                    " Ciao for now"
...
String index() {
  //return header(TITLE) + "<div>" + sMessage + "</ol></div><div><form action=/post method=post><label>Data here:</label>"+
