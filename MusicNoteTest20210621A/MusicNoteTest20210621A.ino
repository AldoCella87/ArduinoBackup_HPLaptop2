/**
   From https://create.arduino.cc/projecthub/abhilashpatel121/arduino-music-notes-and-chord-detector-728b14
...
******/
  ...
  // ae original: if(sum2-sum1>3){ 
  //ae Serial.println(sum2-sum1); 
