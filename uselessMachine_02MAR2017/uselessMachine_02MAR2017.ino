...
void loop() {
  ...
  int iloopMax = 0;
  static int iMyScore, iYourScore = 0;
  ...
  {             
      ...
      #ifdef TEST_MODE
      #define FLAP_PROBAB         100
      #define FLICKER_PROBAB      100
      #define PEEK_PROBAB         100
      #define MULTI_PEEK_PROBAB   100      
      #define LONG_WAIT_PROBAB    100
      #define SLOW_DEPLOY_PROBAB  100
      #define SCORE_BUMP_PROBAB   100
      #define YOU_WIN_PROBAB      100
      #define GO_AWAY_PROBAB      100
      #define SPEAK_TO_ME_PROBAB  100                     // Do you give up?  a bit more loudly please... just say Say yes or no... just kidding - I can't hear!
      #define I_AM_SORI_PROBAB    100                     // "I am Sori ... (pause) "that you are losing"
      #else

      #define FLAP_PROBAB         5
      #define FLICKER_PROBAB      5
      #define PEEK_PROBAB         5
      #define MULTI_PEEK_PROBAB   5      
      #define LONG_WAIT_PROBAB    5
      #define SLOW_DEPLOY_PROBAB  5
      #define SCORE_BUMP_PROBAB   5
      #define YOU_WIN_PROBAB      5
      #define GO_AWAY_PROBAB      5
      #define SPEAK_TO_ME_PROBAB  5
      #define I_AM_SORI_PROBAB    5                       
      ...
      if(random(1,101) <= SCORE_BUMP_PROBAB)
      {                           
      ...
      // conditionally display trick score
      if(random(1,101) <= YOU_WIN_PROBAB)
      {      
        // taunt option 1                
        lcd.clear();                              
        lcd.home();  
      ...
      // taunt 2
      else if(random(1,101) <= I_AM_SORI_PROBAB)
      {      
        lcd.clear();                              
        lcd.home();  
        lcd.print("I am Sori       ");
      ...
      lcd.clear();                              
      lcd.home();                     
      if(random(1,101) <= GO_AWAY_PROBAB)
      {                    
        // annoying behavior       
