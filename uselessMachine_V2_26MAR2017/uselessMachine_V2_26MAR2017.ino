...
#define  TEST_MODE
  ...
  #define FLAP_PROB         4  
  #define MAGNETO_PROB      2
  #define LIGHT_PROB        2
  #define DISTANCE_PROB     2
  #define PERSEVERANCE_PROB 2
  ...
  #define VOX_RESPONSE_DELAY  4000                  // ms to wait for voice response
...
void slowDeploy(void)
{
  ...
  while(i-- > ACTUATOR_FWD_POS +13 && bSwitchState == 1)
  { 
    actServo.write(i);
    delay(100);
    bSwitchState = bcheckSwitchState();
