...
#define TEST_MODE
  ...
  #define PERSEVERANCE_THRESHOLD  4                 // reading required to unlock
...
int checkLockStatus()
{
    ...
    lcd.setCursor (0,1);        
    if(iMagOrient = readMagSensor() > 0)
    {
      bMagStatus = 1;           // once unlocked remain unlocked
