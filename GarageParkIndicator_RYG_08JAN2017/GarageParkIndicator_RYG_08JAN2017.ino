...
const int RedPin = 6;
const int FarEdgeGreen = 59;
const int NearEdgeGreen = 50;
int prev_inches = 0;
int deadbandAddition = 1;
...
if (inches - prev_inches < 10)
  {
    if(inches <= NearEdgeGreen - deadbandAddition){
      digitalWrite(GreenPin, LOW);
    ...
    if ((inches <= FarEdgeGreen - deadbandAddition) && (inches > NearEdgeGreen + deadbandAddition)){
    ...
    if(inches > FarEdgeGreen + deadbandAddition)
    {
    digitalWrite(GreenPin, LOW);
    digitalWrite(YellowPin, HIGH);
    digitalWrite(RedPin, LOW);
