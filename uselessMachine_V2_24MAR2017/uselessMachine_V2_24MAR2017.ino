...
void loop() {
  ...
  if (itoggleCount > 7)
  {
    displayLCD(F("Are you trying"),F("to confuse me?"), 60,2000);
  }
  else if(itoggleCount == 5) 
  {
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,100) <= FLAP_PROB)) flap(myrandom(2,13));
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,100) <= LONG_WAIT_PROB))
    {   
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,101) <= SLOW_DEPLOY_PROB)) slowDeploy();
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,101) <= PEEK_PROB)) peekout(myrandom(600,1200), myrandom(900, 1700));
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,101) <= FLICKER_PROB)) flicker(myrandom(3,27));
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,101) <= MULTI_PEEK_PROB))
    {   
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,101) <= SPEAK_TO_ME_PROB)) speak();
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,101) <= MAGNETO_PROB)) iDisplayMagReading();
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,101) <= LIGHT_PROB)) iDisplayLightReading();
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,101) <= DISTANCE_PROB)) iDisplayDistanceReading();
    ...
    *********************************************************/
    iSwitchState = checkSwitchState();  
    if(iSwitchState == 1 && (myrandom(1,101) <= PERSEVERANCE_PROB)) iDisplayPerseverance();
