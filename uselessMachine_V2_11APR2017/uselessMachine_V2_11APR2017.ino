...
#define  TEST_MODE
  ...
  #define ORIENTATION_PROB  2
  #define LIGHT_PROB        2
  #define DISTANCE_PROB     2
  #define NOISE_PROB        99  
  #define PERSEVERANCE_PROB 2
  #define FLICKER_PROB      2
  #define PEEK_PROB         2
  #define MULTI_PEEK_PROB   2      
  #define LONG_WAIT_PROB    2
  #define SLOW_DEPLOY_PROB  2
  #define SCORE_BUMP_PROB   2
  #define YOU_WIN_PROB      2
  #define GO_AWAY_PROB      2
  #define SPEAK_TO_ME_PROB  2                       // simulated voice input processing
  ...
  #define SCORE_PENALTY_PROB  2                     // "User Response Error Your score has been reset to zero"
  #define GIVEUP_PROB       2                       // probability of displaying wisecrack message regarding persevarance
...
/*********************************************************************
 * deploy actuator to a point almost touching the switch then
 * retract without turning switch off.  
 * 
 *********************************************************************/
void fakeout(void)
